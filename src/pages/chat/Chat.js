...
import './Chat.css';
import emptypic from '../../images/userAvatar.png';
import ChatBox from '../chatbox/ChatBox';
import WelcomeBoard from '../welcome/Welcome';
import chatslogo from './chatslogo.svg';
import roomslogo from './roomslogo.svg';
...
export default class Chat extends React.Component{
    ...
    render(){
        return(
          <div className="root">
              <div className="body">
              <Card className="chatsandrooms">
                  <div className="chatspage" onClick={this.onChatsClick}>
                    <img src={chatslogo} alt="Chats logo"/>
                    Chats
                  </div>
                  <div className="roomspage">
                  <a className="callslink" href="https://mycallsjag.netlify.app" target="_blank">
                  <img src={roomslogo} alt="Calls logo"/>
                    Calls
                  </a>
                  </div>
              </Card>
